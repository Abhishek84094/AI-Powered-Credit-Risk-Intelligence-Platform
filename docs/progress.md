...
| **Layer 3** | ML Model Training & Calibration | **COMPLETE** | 5-Fold Stratified CV, Optuna HPO, Isotonic Calibration | Tuned LightGBM (0.7853 Holdout ROC-AUC, 0.7812 5-Fold CV, 91.91% Accuracy, 339 features), Isotonic calibrated |
